      ...
      <div className="flex items-center gap-3 sm:gap-6">
        ...
        <button className="hidden md:block p-1 text-secondary hover:text-foreground">
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M14.6667 5.33333H12.6667L14.6667 3.33333V5.33333ZM14.6667 10.6667V8.66667L12.6667 10.6667H14.6667ZM10.6667 14.6667V12.6667L8.66667 14.6667H10.6667ZM5.33333 14.6667H3.33333L5.33333 12.6667V14.6667ZM1.33333 10.6667V8.66667L3.33333 10.6667H1.33333ZM1.33333 5.33333H3.33333L1.33333 3.33333V5.33333ZM5.33333 1.33333V3.33333L3.33333 1.33333H5.33333ZM10.6667 1.33333H8.66667L10.6667 3.33333V1.33333Z" fill="currentColor"/>
          </svg>
        </button>
