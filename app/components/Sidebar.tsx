    ...
    items: [
      ...
      },
      {
        ...
        icon: (
          ...
          >
            <path
              d="M11.8641 14.1156C13.5677 14.1156 14.9488 12.6474 14.9488 10.8363C14.9488 9.02524 13.5677 7.55705 11.8641 7.55705C10.1605 7.55705 8.77945 9.02524 8.77945 10.8363C8.77945 12.6474 10.1605 14.1156 11.8641 14.1156Z"
              stroke="currentColor"
              strokeWidth="1.5"
            />
            <path
              d="M3.57901 8.92342C5.5267 -0.178682 18.2114 -0.168171 20.1492 8.93393C21.2862 14.2733 18.162 18.7928 15.4234 21.5886C13.4361 23.6276 10.2921 23.6276 8.295 21.5886C5.56625 18.7928 2.44203 14.2628 3.57901 8.92342Z"
              stroke="currentColor"
              strokeWidth="1.5"
            />
          </svg>
      ...
      },
      {
        ...
        icon: (
          ...
          >
            <path
              d="M22 6.22522V8.64522C22 10.2252 21 11.2252 19.42 11.2252H16V4.23522C16 3.12522 16.91 2.22522 18.02 2.22522C19.11 2.23522 20.11 2.67522 20.83 3.39522C21.55 4.12522 22 5.12522 22 6.22522Z"
              stroke="currentColor"
              strokeWidth="1.5"
              strokeMiterlimit="10"
              strokeLinecap="round"
            ...
            />
            <path
              d="M2 7.22522V21.2252C2 22.0552 2.93998 22.5252 3.59998 22.0252L5.31 20.7452C5.71 20.4452 6.27 20.4852 6.63 20.8452L8.28998 22.5152C8.67998 22.9052 9.32002 22.9052 9.71002 22.5152L11.39 20.8352C11.74 20.4852 12.3 20.4452 12.69 20.7452L14.4 22.0252C15.06 22.5152 16 22.0452 16 21.2252V4.22522C16 3.12522 16.9 2.22522 18 2.22522H7H6C3 2.22522 2 4.01522 2 6.22522V7.22522Z"
              stroke="currentColor"
              strokeWidth="1.5"
              strokeMiterlimit="10"
              strokeLinecap="round"
      ...
      },
      {
        ...
        icon: (
          ...
          >
            <path
              d="M3.17001 7.66522L12 12.7752L20.77 7.69519"
              stroke="currentColor"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
            ...
            />
            <path
              d="M9.92999 2.70522L4.59 5.67525C3.38 6.34525 2.39001 8.02523 2.39001 9.40523V15.0553C2.39001 16.4353 3.38 18.1152 4.59 18.7852L9.92999 21.7553C11.07 22.3853 12.94 22.3853 14.08 21.7553L19.42 18.7852C20.63 18.1152 21.62 16.4353 21.62 15.0553V9.40523C21.62 8.02523 20.63 6.34525 19.42 5.67525L14.08 2.70522C12.93 2.06522 11.07 2.06522 9.92999 2.70522Z"
              stroke="currentColor"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
            <path
              d="M17 13.4652V9.80524L7.51001 4.3252"
              stroke="currentColor"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
      ...
      },
      {
        ...
        icon: (
          ...
          >
            <path
              d="M11.95 8.17522L10.536 9.58922L8 7.05322V20.2252H6V7.05322L3.465 9.58922L2.05 8.17522L7 3.22522L11.95 8.17522ZM21.95 16.2752L17 21.2252L12.05 16.2752L13.464 14.8612L16.001 17.3972L16 4.22522H18V17.3972L20.536 14.8612L21.95 16.2752Z"
              fill="currentColor"
            />
          </svg>
        ),
      ...
      },
      {
        ...
        icon: (
          ...
          >
            <path
              d="M12.62 21.0352C12.28 21.1552 11.72 21.1552 11.38 21.0352C8.48 20.0452 2 15.9152 2 8.91523C2 5.82523 4.49 3.32523 7.56 3.32523C9.38 3.32523 10.99 4.20523 12 5.56523C13.01 4.20523 14.63 3.32523 16.44 3.32523C19.51 3.32523 22 5.82523 22 8.91523C22 15.9152 15.52 20.0452 12.62 21.0352Z"
              stroke="currentColor"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
      ...
      },
      {
        ...
        icon: (
          ...
          >
            <path
              d="M9.00684 5.56456C9.86699 5.29129 10.8161 5.11261 11.8641 5.11261C16.5999 5.11261 20.4359 9.19069 20.4359 14.2252C20.4359 19.2598 16.5999 23.3378 11.8641 23.3378C7.12836 23.3378 3.29229 19.2598 3.29229 14.2252C3.29229 12.3544 3.82618 10.6096 4.73576 9.15916"
              stroke="currentColor"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
            <path
              d="M7.78088 5.81682L10.6382 2.32733"
              stroke="currentColor"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
            <path
              d="M7.78088 5.81683L11.1127 8.40242"
              stroke="currentColor"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
    ...
    items: [
      {
        ...
        icon: (
          ...
          >
            <path
              d="M9.5 14.2004C9.5 15.1704 10.25 15.9504 11.17 15.9504H13.05C13.85 15.9504 14.5 15.2704 14.5 14.4204C14.5 13.5104 14.1 13.1804 13.51 12.9704L10.5 11.9204C9.91 11.7104 9.51001 11.3904 9.51001 10.4704C9.51001 9.63043 10.16 8.94043 10.96 8.94043H12.84C13.76 8.94043 14.51 9.72043 14.51 10.6904"
              stroke="currentColor"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
            ...
            />
            <path
              d="M22 12.4504C22 17.9704 17.52 22.4504 12 22.4504C6.48 22.4504 2 17.9704 2 12.4504C2 6.93044 6.48 2.45044 12 2.45044"
              stroke="currentColor"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
...
export function Sidebar({
  ...
  return (
    ...
    >
      {/* Header with centered Logo and separator */}
      <div className="relative flex h-[93px] items-center px-[30px]">
        {!isCollapsed && (
          <>
            {/* Thick separator line */}
            <div className="absolute left-0 right-0 top-[95%] h-[1.5px] bg-gray-border" />
            {/* Logo text without background - line shows through letter spacing */}
            <div className="absolute left-1/2 top-[85%] -translate-x-1/2 -translate-y-1/2 z-10">
              <h1 className="text-[64px] font-bold leading-[1] text-teal-light">
                Logo
              </h1>
            </div>
          </>
              ...
              {section.title === "324" && !isCollapsed && (
                <div className="mt-2.5 space-y-0 pl-6">
                  ...
                  >
                    ...
                    >
                      <path
                        d="M12 22.4504C17.5228 22.4504 22 17.9733 22 12.4504C22 6.92759 17.5228 2.45044 12 2.45044C6.47715 2.45044 2 6.92759 2 12.4504C2 17.9733 6.47715 22.4504 12 22.4504Z"
                        stroke="currentColor"
                        strokeWidth="1.5"
                      />
                      <path
                        d="M12 6.45044V18.4504M15 9.95044C15 8.57044 13.657 7.45044 12 7.45044C10.343 7.45044 9 8.57044 9 9.95044C9 11.3304 10.343 12.4504 12 12.4504C13.657 12.4504 15 13.5704 15 14.9504C15 16.3304 13.657 17.4504 12 17.4504C10.343 17.4504 9 16.3304 9 14.9504"
                        stroke="currentColor"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                      />
                  ...
                  >
                    ...
                    >
                      <path
                        d="M3.01 11.6704V16.1604C3.01 20.6504 4.81 22.4504 9.3 22.4504H14.69C19.18 22.4504 20.98 20.6504 20.98 16.1604V11.6704"
                        stroke="currentColor"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M12 12.4504C13.83 12.4504 15.18 10.9604 15 9.13044L14.34 2.45044H9.67L9 9.13044C8.82 10.9604 10.17 12.4504 12 12.4504Z"
                        stroke="currentColor"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M18.31 12.4504C20.33 12.4504 21.81 10.8104 21.61 8.80044L21.33 6.05044C20.97 3.45044 19.97 2.45044 17.35 2.45044H14.3L15 9.46044C15.17 11.1104 16.66 12.4504 18.31 12.4504Z"
                        stroke="currentColor"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M5.64 12.4504C7.29 12.4504 8.78 11.1104 8.94 9.46044L9.16 7.25044L9.64 2.45044H6.59C3.97 2.45044 2.97 3.45044 2.61 6.05044L2.34 8.80044C2.14 10.8104 3.62 12.4504 5.64 12.4504Z"
                        stroke="currentColor"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M12 17.4504C10.33 17.4504 9.5 18.2804 9.5 19.9504V22.4504H14.5V19.9504C14.5 18.2804 13.67 17.4504 12 17.4504Z"
                        stroke="currentColor"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
